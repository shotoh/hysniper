...
public class BazaarChecker {
    ...
    public void checkBazaar() {
        try {
            ...
            if (page.isSuccess()) {
                ...
                addPrice(page, "ENCHANTMENT_VENOMOUS_6", "Venomous 6", 0.86);
    ...
    private void addPrice(BazaarPage page, String id, String name, double percent) {
        mod.getPriceChecker().getPrices().put(id, new SkyblockItem(id, name, percent, getProductPrice(page, id, percent)));
    }
}
